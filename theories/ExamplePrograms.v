...
Definition FibProgram : Program.
  ...
  apply (cons (movI (bitvector_fin_big [b0; b0]), inl (nat_bitvector_big _ 1))).
    (*1: Store [00] at address 0001 *)
  apply (cons (store_wI (bitvector_fin_big [b0; b0]), inl (nat_bitvector_big _ 1))).
  ...
  apply (cons (load_wI (bitvector_fin_big [b1; b0]), inl (nat_bitvector_big _ 2))).
  ...
  apply (cons (store_wI (bitvector_fin_big [b0; b1]), inl (nat_bitvector_big _ 2))).
