...
Module Info.
  ...
  Definition source_file := "factwhile.c".
...
Definition f_fact := {|
  ...
  fn_vars := nil;
  fn_temps := ((_y, tint) :: nil);
  fn_body :=
(Ssequence
  (Sset _y (Econst_int (Int.repr 1) tint))
  (Ssequence
    (Swhile
      (Ebinop Ogt (Etempvar _x tint) (Econst_int (Int.repr 0) tint) tint)
      (Ssequence
        (Sset _y (Ebinop Omul (Etempvar _y tint) (Etempvar _x tint) tint))
        (Sset _x
...
(Ssequence
  (Ssequence
    (Ssequence
      (Scall (Some _t'1)
        (Evar _fact (Tfunction (Tcons tint Tnil) tint cc_default))
          ...
          (Sset _t'2
            (Ecast
              (Ebinop Oeq (Etempvar _t'3 tint)
                (Econst_int (Int.repr 120) tint) tint) tbool)))
...
((___builtin_ais_annot,
 ...
 (___builtin_debug,
   Gfun(External (EF_external "__builtin_debug"
     ...
     {|cc_vararg:=(Some 1); cc_unproto:=false; cc_structret:=false|})) ::
 (_fact, Gfun(Internal f_fact)) :: (_main, Gfun(Internal f_main)) :: nil).

Definition public_idents : list ident :=
(_main :: _fact :: ___builtin_debug :: ___builtin_write32_reversed ::
