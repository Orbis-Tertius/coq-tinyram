...
Module Info.
  ...
  Definition source_file := "polynomial_in_main.c".
...
Definition f_main := {|
  ...
  fn_params := nil;
  fn_vars := nil;
  fn_temps := ((_x, tint) :: (_y, tint) :: (_z, tint) :: nil);
  fn_body :=
(Ssequence
  (Ssequence
    (Sset _x (Econst_int (Int.repr 4) tint))
    (Ssequence
      (Sset _y (Econst_int (Int.repr 2) tint))
      (Ssequence
        (Sset _z (Econst_int (Int.repr 3) tint))
        (Sreturn (Some (Ebinop Oadd
                         (Ebinop Oadd
                           (Ebinop Omul
                             (Ebinop Omul (Econst_int (Int.repr 3) tint)
                               (Etempvar _x tint) tint) (Etempvar _x tint)
                             tint)
                           (Ebinop Omul (Econst_int (Int.repr 4) tint)
                             (Etempvar _y tint) tint) tint)
                         (Ebinop Omul
                           (Ebinop Omul
                             (Ebinop Omul (Econst_int (Int.repr 5) tint)
                               (Etempvar _z tint) tint) (Etempvar _z tint)
                             tint) (Etempvar _z tint) tint) tint))))))
