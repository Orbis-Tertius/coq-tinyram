...
Module Info.
  ...
  Definition source_file := "bitand.c".
...
(Ssequence
  (Ssequence
    (Sset _a (Econst_int (Int.repr 60) tint))
    (Ssequence
      (Sset _b (Econst_int (Int.repr 13) tint))
      (Sreturn (Some (Ebinop Oand (Etempvar _a tint) (Etempvar _b tint) tint)))))
